...
export const MainHow: React.FC = () => {
  return (
    <div className={Styles.how}>
      ...
      <span className={`${Styles.title} ${Styles.title__device__mobile}`}>Как это работает?</span>
      <div className={Styles.container}>
        <span className={`${Styles.title} ${Styles.title__device__desktop}`}>Как это работает?</span>
        <ul className={`${Styles.list} ${Styles.list__device__desktop}`}>
        ...
        <ul className={`${Styles.list} ${Styles.list__device__mobile}`}>
          <li className={Styles.item}>
            <span>Покупая LIMC, вы приобретаете майнинговую мощность из нашего дата-центр</span>
            <span>
              Это самый простой и безопасный способ инвестирования в майнинг, поскольку токен LIMC в ближайшее время
