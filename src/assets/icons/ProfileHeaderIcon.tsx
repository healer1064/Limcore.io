...
export const ProfileHeaderIcon = ({ className }) => {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        strokeWidth='2'
      />
      <path d='M21.8 7.5H31.9' stroke='#4A70F8' strokeLinecap='round' strokeMiterlimit='10' strokeWidth='2' />
      <path d='M21.8 11.2H31.9' stroke='#4A70F8' strokeLinecap='round' strokeMiterlimit='10' strokeWidth='2' />
      <path d='M21.8 14.8H31.9' stroke='#4A70F8' strokeLinecap='round' strokeMiterlimit='10' strokeWidth='2' />
      <path d='M21.8 18.5H31.9' stroke='#4A70F8' strokeLinecap='round' strokeMiterlimit='10' strokeWidth='2' />
    </svg>
  )
}
