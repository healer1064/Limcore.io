...
export const GameStart: React.FC<GameStartProps> = ({ clientWidth }) => {
  return (
    <section className={styles.gameStart}>
      <h2 style={{ marginBottom: '50px' }}>Запуск игры</h2>
      <div className={styles.gameStart__twoMods}>
        <div>
          <h3 className={styles.title}>2 режима</h3>
        ...
        <div>
          <h3 className={styles.title}>1 земля = 1 LIMC</h3>
          <p className={styles.text}>
            Пользователь может купить <br /> земельный участок для <br /> выращивания или создания <br /> токенов
          </p>
