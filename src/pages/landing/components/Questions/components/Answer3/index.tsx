  ...
  return (
    <>
      <ul className={list === 'mobile' ? `${Styles.list} ${Styles.list_mod}` : `${Styles.list}`}>
        <li>
          <p className={Styles.text}>Низкий порог входа с 0,1 LIMC.</p>
        </li>
        <li>
          <p className={Styles.text}>
            Не требуется дорогостоящее оборудование или техническое обслуживание. Никаких дополнительных затрат на
            электроэнергию и т. д. Высокая эффективность фарминга.
          </p>
        </li>
        <li>
        ...
        <li>
          <p className={Styles.text}>
            ...
            оборудование полностью принадлежат Limcore по праву собственности.
          </p>
        </li>
      </ul>
      <p className={Styles.text}>
