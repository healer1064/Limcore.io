      ...
      <div className={Styles.wrapper}>
        ...
        <div className={Styles.container}>
          ...
          <div className={Styles.info}>
            ...
            <p className={Styles.text}>
              Процедуры верификации могут отличаться в зависимости от характера бизнеса, однако преследуют они одни и те
              же цели. Основные этапы процедуры – сбор и проверка данных. Сюда также относится комплексная проверка и
              постоянный мониторинг пользователей.
            </p>
          </div>
        </div>
      </div>
